...
public class TiposDeDatos {
	...
	//Es decir, todo lo que esté declarado dentro de él, el sistema
	//va a buscar este método y lo ejecutará
	...
	//Ejemplo de declarar un tipo de dato byte, sin valor asignado
		...
		//Más adelante podemos asignar un valor a esta variable
		...
		//y puede almacenar valores más alla de los int, siempre y cuando
		//se le agregue el sufijo "L"
		
		//La variable más utilizada (comodín) es la de tipo int
		 ...
		 * son "clases", las cuales van a proporcionarnos métodos
